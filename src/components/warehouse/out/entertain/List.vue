<template>
  <div class="table-list">
    <div class="action">
      <el-button type="primary" size="small" @click="add">新增出库商品</el-button>
      <!--{{$route.query.out_id}}-->
    </div>
    ...
    <el-table :data="tableData" :default-sort="sortInfo" @sort-change="sortChange"
      ...
      <el-table-column prop="out_time" label="招待时间" min-width="80"></el-table-column>
      <el-table-column prop="user_name" label="领用人" min-width="50"></el-table-column>
      <el-table-column prop="approver_name" label="审批人" min-width="50"></el-table-column>
      <el-table-column prop="out_remark" label="招待备注" min-width="50"></el-table-column>
