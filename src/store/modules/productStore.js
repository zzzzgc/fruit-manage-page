...
const state = {
  ...
  fruitTypeList: ['月饼', '牛油果', '车厘子', '零食', '饮料', '水', '奇异果', '无', '提子', '枣', '柚', '桃', '杏', '甜瓜', '荔枝', '甘蔗', '柿', '柠檬', '香蕉', '芒果', '菠萝', '哈密瓜', '李', '石榴', '枸杞', '椰子', '荸荠', '沙糖桔', '木瓜', '橙', '圣女果', '龙眼', '黄瓜', '山竹', '红毛丹', '无花果', '布朗', '杨桃', '猕猴桃', '芭乐', '杨梅', '乌梅', '蓝莓', '西梅', '释迦', '百花果', '黄皮', '雪莲果', '榴莲', '火龙果', '番石榴', '菠萝蜜', '百香果', '罗汉果', '莲雾', '核桃', '开心果', '银杏', '松子', '果仁', '白果', '坚果', '果脯', '槟榔果', '腰果', '果汁', '果酒', '罐头', '果酱', '果干', '脱水水果', '果茶', '果味粉', '速冻水果', '梅', '橄榄', '樱桃', '李子', '桃子', '草莓', '树莓', '桑葚', '葡萄', '人参果', '枇杷', '山楂', '梨', '沙果', '苹果', '桔子', '柑橘', '橙子', '柚子', '佛手', '杏仁', '榛子', '板栗', '花生', '瓜子', '白兰瓜', '西瓜', '香瓜'],
  measureUnitList: ['箱', '斤'],
  productionInfoList: [
    {
      label: '中国',
  ...
  freshMinuteList: [{id: 1, name: '1天'}, {id: 3, name: '3天'}, {id: 7, name: '7天'}, {id: 10, name: '10天'}, {
    id: 15,
    name: '15天'
  }, {id: 30, name: '30天'}, {id: 60, name: '60天'}, {id: 180, name: '180天'}, {id: 365, name: '365天'}]
}

// 执行异步获取数据，如ajax
const actions = {
  [PRODUCT_TYPE_LIST]: function ({commit, state}) {
...
// 必须同步更改数据
const mutations = {
  [PRODUCT_TYPE_LIST_SET]: function (state, {typeList}) {
